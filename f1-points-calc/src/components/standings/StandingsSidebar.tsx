...
const StandingsSidebar: React.FC<Props> = ({ activeSeason }) => {
  ...
  return (
    <div className="h-full overflow-hidden flex flex-col bg-gradient-to-b from-slate-50 to-white pb-3">
      <div className="px-3 py-2 border-b border-slate-200 bg-gradient-to-r from-slate-50 to-slate-100 flex items-center justify-between gap-2">
        <h2 className="text-base font-semibold font-display text-slate-800 truncate">
      ...
      <div className="overflow-auto flex-1">
        ...
        <div className="mx-3 mt-3 pt-3 border-t text-xs text-ink-muted flex flex-wrap gap-x-3 gap-y-1">
          ...
          <a href="mailto:f1pointscalculator@yashyegare.com" className="hover:text-ink">Contact</a>

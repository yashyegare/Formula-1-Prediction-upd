                ...
                >
                  <td className="py-1.5 px-2 text-center font-bold text-sm w-10 tnum font-display">
                    <div className="flex items-baseline justify-center gap-0.5">
                      <span className={`${standing.position <= 3 ? 'bg-gradient-to-br from-amber-400 to-orange-500 text-white w-6 h-6 rounded-full flex items-center justify-center' : 'text-slate-600'}`}>{standing.position}</span>
                  ...
                  <td
                    className={`py-1.5 px-2 font-bold text-sm text-right tnum font-display ${animatedDrivers[standing.driverId] ? 'animate-points-update' : ''}`}
                  >

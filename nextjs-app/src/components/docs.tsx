...
/* Facts about the CURRENT production system — kept in sync with what
   actually runs in flask-app/, unlike the 2023 write-up below. */
const SYSTEM_FACTS = [
    { label: "Model", value: "XGBoost · 3-class" },
    { label: "Data", value: "Jolpica-F1 · 2018–2026" },
    { label: "Accuracy (post-fix)", value: "~66%" },
    ...
    return (
        <>
            ...
            <div className="page-body">
                ...
                The primary objective is to propose a machine-learning approach to predict the winner of the following Formula 1 Grand Prix race. I aim to provide an accurate prediction that considers various present and past factors to help fans, team managers, and bettors make informed decisions. I aim to do robust data analysis and find the factors contributing towards winners while also predicting the band of winners
            </p><p id="351ede97-a0b8-4ef8-86b6-22c7ef4bd3be" ><strong>Scope:</strong>
                ...
                applied regression and classification techniques to predict the bands of winners. Based on the approach I will draw out inferences on major statistics and major winning factors. The approach can be applied to any Formula 1 race andcan be helpful for fans, team managers, and bettors in making informed decisions. 
